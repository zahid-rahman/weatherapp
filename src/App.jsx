...
function App() {
  ...
  const getCurrentWeatherDetails = (regionName) => {
  ...
  useEffect(() => {
    getCurrentLocation()
    getCurrentWeatherDetails(currentLocationDetails)
  ...
  return (
    <div className="container">
      ...
      <DisplayWeather error={error} weather={weatherDetails}></DisplayWeather>
    </div>
  );
}
